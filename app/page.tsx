...
const TESTIMONIALS = [
  {
    text: 'Kreipiausi dėl sugriuvusios svetainės — Mantas sutaisė per kelias valandas. Greitas, kompetentingas, aiškiai paaiškina.',
    author: 'Tomas K.',
...
export default function Home() {
  return (
    <main style={{ background: '#f8fafc', minHeight: '100vh' }}>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 420px', gap: 60, alignItems: 'center' }}>
          ...
          <div>
            ...
            <h1 style={{
              ...
              Jūsų svetainė<br />veikia tobulai.
            </h1>

            <p style={{ fontSize: 18, color: '#bfdbfe', margin: '0 0 28px', lineHeight: 1.6 }}>
              Web remontas, AI svetainės, WordPress, serverių diegimas.<br />
              Greitas, patikimas, pigus — nuo <strong style={{ color: '#fff' }}>€39</strong>.
            </p>
          ...
          <div style={{
            ...
            <div style={{ fontSize: 13, color: '#64748b', marginBottom: 20 }}>Pasirinkite paslaugą ir gaukite pasiūlymą</div>
            ...
            {[
              ...
              <a key={label} href="#kontaktai" style={{
                ...
                marginBottom: 10, textDecoration: 'none', cursor: 'pointer',
              }}>
                ...
                <span style={{
                  ...
                  background: badge, borderRadius: 6, padding: '3px 10px',
                }}>
                  {price}
                </span>
              </a>
      ...
      {/* ── TRUST BAR ── */}
      <section style={{ background: '#1e3a8a', padding: '18px 40px' }}>
        <div style={{
          ...
          {TRUST_ITEMS.map(({ icon, label }) => (
            <div key={label} style={{ display: 'flex', alignItems: 'center', gap: 8, color: '#bfdbfe', fontSize: 14 }}>
      ...
      {/* ── ABOUT ── */}
      <section id="apie" style={{ padding: '80px 40px', background: '#fff' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 60, alignItems: 'center' }}>
          ...
          <div>
            ...
            <h2 style={{ fontSize: 36, fontWeight: 800, color: '#0f172a', margin: '0 0 16px', lineHeight: 1.2 }}>
              Solo IT specialistas su aistra technologijoms
            </h2>
            <p style={{ fontSize: 16, color: '#475569', lineHeight: 1.7, margin: '0 0 16px' }}>
              Sveiki! Aš esu <strong>Mantas</strong> — nepriklausomas web kūrėjas ir IT specialistas iš Lietuvos.
              Dirbu su klientais tiesiogiai, be tarpininkų, todėl galiu pasiūlyti geresnę kainą ir greitesnį atsakymą.
            </p>
            <p style={{ fontSize: 16, color: '#475569', lineHeight: 1.7, margin: '0 0 24px' }}>
              ...
              būtų greitas, modernus ir efektyvus. Kiekvienas projektas man yra asmeninis iššūkis.
            </p>
      ...
      {/* ── SERVICES ── */}
      <section id="paslaugos" style={{ padding: '80px 40px', background: '#f8fafc' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            <div style={{ fontSize: 12, fontWeight: 700, color: '#2563eb', letterSpacing: 2, textTransform: 'uppercase', marginBottom: 12 }}>
              Paslaugos
            </div>
            <h2 style={{ fontSize: 36, fontWeight: 800, color: '#0f172a', margin: 0 }}>
          ...
          <div style={{
            ...
            {SERVICES.map(({ icon, title, desc, price }) => (
              <div key={title} style={{
                ...
                <div style={{ fontSize: 14, color: '#64748b', lineHeight: 1.6, flex: 1, marginBottom: 16 }}>{desc}</div>
                <div style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
            {TESTIMONIALS.map(({ text, author, role }) => (
              <div key={author} style={{
                ...
                <div style={{ fontSize: 32, color: '#2563eb', marginBottom: 12, lineHeight: 1 }}>&ldquo;</div>
      ...
      <section id="kontaktai" style={{
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            ...
            <p style={{ fontSize: 16, color: '#bfdbfe', marginTop: 12 }}>
              Parašykite — atsakysime per 24 valandas ir pasiūlysime geriausią sprendimą.
            </p>
          </div>
          ...
          <div style={{ textAlign: 'center', marginTop: 28, display: 'flex', justifyContent: 'center', gap: 32, flexWrap: 'wrap' }}>
            <a href="mailto:info@nodas.lt" style={{ color: '#93c5fd', fontSize: 14, textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 6 }}>
              ✉️ info@nodas.lt
            </a>
            <span style={{ color: '#bfdbfe', fontSize: 14, display: 'flex', alignItems: 'center', gap: 6 }}>
              🇱🇹 Lietuva
            </span>
            <span style={{ color: '#bfdbfe', fontSize: 14, display: 'flex', alignItems: 'center', gap: 6 }}>
              ⚡ Atsakome per 24 val.
